...
<main>
  <div>
    <div class="text-center pb-3">
      <img class="img-fluid" src="../img/miniinfinity/MiniInfinity.png" width="500px">
    </div>
...
it should act depending on what is happening in the world around it.
  ...
  <div class="text-center pb-3">
    <img class="img-fluid" src="../img/miniinfinity/miCharacer_Enemy.png" width="500px">
  </div>
...
to an item base class if we able to add more Relics. Pictured bellow is the Relic:
  ...
  <div class="text-center pb-3">
    <img class="img-fluid" src="../img/miniinfinity/miRelic.png" width="500px">
  </div>
...
menu.
  ...
  <div class="text-center pb-3">
    <img class="img-fluid" src="../img/miniinfinity/miSettings_menu.png" width="500px">
  </div>
...
animation tree:
  ...
  <div class="text-center pb-3">
    <img class="img-fluid" src="../img/miniinfinity/miAnimation_Tree.png" width="500px">
  </div>
